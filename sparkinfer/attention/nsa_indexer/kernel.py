...
def _run_paged_tiled_logits_kernel_common(
    *,
    ...
    logits_view._sparkinfer_num_q_tiles = num_q_tiles
    logits_view._sparkinfer_num_k_tiles = num_k_tiles
    logits_view._sparkinfer_block_q = int(tile_block_q)
    logits_view._sparkinfer_block_k = int(tile_block_k)
    return logits_view
...
_INDEXER_STREAM_SCORER_ENV = "SPARKINFER_INDEXER_STREAM_SCORER"
